...
<form:form role="form" action="create" modelAttribute="contractor" id="contractorform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
